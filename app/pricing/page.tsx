    ...
    <div className="wrap">
      ...
      <section className="pricing">
        ...
        <p className="pricing__sub">
          One sale you win back from better rankings covers months of Perch.
        </p>
        ...
        <div className="tiers">
          {tiers.map((t) => (
            <div key={t.name} className={`tier ${t.featured ? "tier--featured" : ""}`}>
              ...
              <a href={t.href} className={`btn ${t.featured ? "" : "btn--outline"}`}>
                {t.cta}
              </a>
            </div>
          ))}
        ...
        <p className="pricing__note">
          Prices in USD. Cancel anytime. No card needed for the free plan.
        </p>
      </section>
    </div>
  );
